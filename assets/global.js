const sliderInit = (isUpdate) => {
	if (
		...
		document.querySelectorAll(".js-media-list").forEach((elem, index) => {
			let prevButton = elem.closest('.product').querySelector('.product__slider-nav .swiper-button-prev');
			let nextButton = elem.closest('.product').querySelector('.product__slider-nav .swiper-button-next');
			...
			let slider = new Swiper(elem, {
				...
				on: {
					...
					slideChangeTransitionEnd: function () {
                        ...
                        // if(this.slides[this.activeIndex].querySelector('template')?.content?.querySelector('video')){
                        //   this.slides[this.activeIndex].querySelector('template')?.content?.querySelector('video').play();
                        // }
